    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_ru",
                    models.CharField(max_length=255, unique=True, verbose_name="Название на русском"),
                ),
                (
                    "name_en",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_vegan",
                    models.BooleanField(default=False, verbose_name="Вегетарианское меню"),
                ),
                (
                    "is_special",
                    models.BooleanField(default=False, verbose_name="Специальное предложение"),
                ),
                ...
                (
                    "name_ru",
                    models.CharField(max_length=255, verbose_name="Название на русском"),
                ),
                (
                    "description_ru",
                    models.CharField(
